        ...
        >
          ...
          <g className="cursor-pointer group" id="map-element-zoneA" onClick={() => onSelectZone("Sector_A")}>
            <path
              ...
              className={`transition-colors duration-300 stroke-2 ${selectedZone === "Sector_A" ? "fill-cyan-900/60 stroke-cyan-400" : "fill-slate-800/80 stroke-slate-700 hover:fill-slate-700"}`}
            />
          ...
          <g className="cursor-pointer group" id="map-element-zoneB" onClick={() => onSelectZone("Sector_B")}>
            <path
              ...
              className={`transition-colors duration-300 stroke-2 ${selectedZone === "Sector_B" ? "fill-cyan-900/60 stroke-cyan-400" : getZoneBStatus()}`}
            />
          ...
          <g className="cursor-pointer group" id="map-element-zoneC" onClick={() => onSelectZone("Sector_C")}>
            <path
              ...
              className={`transition-colors duration-300 stroke-2 ${selectedZone === "Sector_C" ? "fill-cyan-900/60 stroke-cyan-400" : getPlazaCStatus()}`}
            />
          ...
          <g className="cursor-pointer group" id="map-element-zoneD" onClick={() => onSelectZone("Sector_D")}>
            <path
              ...
              className={`transition-colors duration-300 stroke-2 ${selectedZone === "Sector_D" ? "fill-cyan-900/60 stroke-cyan-400" : "fill-slate-800/80 stroke-slate-700 hover:fill-slate-700"}`}
            />
          ...
          <g className="cursor-pointer group" id="map-element-gate1" onClick={() => onSelectZone("Gate_1")}>
            <circle cx="190" cy="360" r="16" className="fill-slate-800 stroke-slate-600 hover:fill-slate-700 stroke-2" />
          ...
          <g className="cursor-pointer group" id="map-element-gate2" onClick={() => onSelectZone("Gate_2")}>
            <circle cx="240" cy="210" r="16" className="fill-slate-800 stroke-slate-600 hover:fill-slate-700 stroke-2" />
          ...
          <g className="cursor-pointer group" id="map-element-gate3" onClick={() => onSelectZone("Gate_3")}>
            <circle cx="560" cy="210" r="16" className="fill-slate-800 stroke-slate-600 hover:fill-slate-700 stroke-2" />
          ...
          <g className="cursor-pointer group" id="map-element-gate4" onClick={() => onSelectZone("Gate_4")}>
            <circle cx="400" cy="165" r="20" className={`transition-all duration-300 stroke-2 ${getGate4Status()}`} />
          ...
          <g className="cursor-pointer group" id="map-element-gate5" onClick={() => onSelectZone("Gate_5")}>
            <circle cx="610" cy="360" r="16" className="fill-slate-800 stroke-slate-600 hover:fill-slate-700 stroke-2" />
          ...
          <g className="cursor-pointer" onClick={() => onSelectZone("First_Aid_Post_2")}>
            <rect x="530" y="280" width="22" height="22" rx="3" fill="#ef4444" stroke="#fca5a5" strokeWidth="1" />
          ...
          <g className="cursor-pointer" onClick={() => onSelectZone("Concession_Plaza_C")}>
            <rect x="520" y="400" width="22" height="22" rx="3" fill="#f59e0b" stroke="#fcd34d" strokeWidth="1" />
